...
//                                    anchors.verticalCenter: parent.verticalCenter
    ...
    states: [
        ...
        State {
            name: "state4"
            when: isDoneLoading === true && isStateFour === true
            PropertyChanges {
                target: lastCheckInMessage
                text: qsTr("Last checked in today")
            }
            ...
            PropertyChanges {
                target: element11
                color: "#06b576"
                text: qsTr("You've Checked in for the day!")
                visible: true
                font.bold: true
                font.pixelSize: 20
                font.family: "Lato"
            ...
            PropertyChanges {
                target: time
                color: "#7131bf"
                text: qsTr("Checked in")
                visible: false
            }
        },
        State {
            name: "state2"
            when: isDoneLoading === true && isStateTwo === true
            PropertyChanges {
                target: checkInButton
                visible: false
            }
        ...
        State {
            name: "state1"
            when: isDoneLoading === true && isStateOne === true
            PropertyChanges {
                target: element11
                visible: false
            }
